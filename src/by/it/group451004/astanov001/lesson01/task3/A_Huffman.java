package by.it.group451004.astanov001.lesson01.task3;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        // Специальный случай: если только один символ, добавим фальшивый второй узел
        if (priorityQueue.size() == 1) {
            priorityQueue.add(new LeafNode(0, '\0')); // '\0' — пустой символ, не встретится в строке
        }
